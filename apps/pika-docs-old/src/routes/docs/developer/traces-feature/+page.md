---
title: Traces Feature
description: Imported from docs/developer/traces-feature.md
outline: [2, 3]
---
...
- **[Verify Response Feature](/docs/developer/verify-response-feature/)**: Adds verification traces to the display
- **[Content Admin Feature](/docs/developer/content-admin/)**: Allows admins to see traces for other users
- **[Overriding Features](/docs/developer/overriding-features/)**: How to override trace settings per chat app
