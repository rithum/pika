...
heroImage: /assets/pika-logo-only.png
tagline: AWS framework that removes AI adoption and infrastructure complexity for rapid agent development and fast iteration cycles
actions:
    - label: Get Started
...
features:
    - title: Advanced Chat Apps
      ...
      link: /docs/features/advanced-chat-apps
    - title: Built on Amazon Web Services
      description: AWS does all the heavy lifting with AWS  Bedrock, Lambda, DynamoDB and OpenSearch
      icon:
          type: svg
          ...
          collection: logos
          name: svelte-kit
      link: /docs/features/built-on-aws
    - title: LLM-based Agents
      description: Create agents using Bedrock foundation models to power your chat apps and agentic workflows
      icon:
          type: svg
      ...
      link: /docs/features/llm-based-agents
    - title: Agents as Configuration
      description: Define agents in existing microservice deployments as config
      icon:
          type: svg
          ...
          collection: vscode-icons
          name: file-type-svelte
      link: /docs/features/agents-as-config
    - title: Self Correcting
      description: Agent responses are evaluated by independent LLM and have self-correcting feedback loop
      icon:
          type: svg
          value: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trending-up-icon lucide-trending-up"><path d="M16 7h6v6"/><path d="m22 7-8.5 8.5-5-5L2 17"/></svg>'
          collection: logos
          name: typescript-icon
      link: /docs/features/self-correcting
    - title: LLM-generated Feedback
      description: An LLM reviews completed chat sessions and adds feedback to help improve agent responses
      link: /docs/features/llm-generated-feedback
      icon:
          type: svg
          ...
          name: typescript-icon
    - title: Insights
      description: Auto-generated metrics and LLM-grading gives visibility into what works and what doesn't
    ...
    - title: Highly Customizable
      description: Integrate your auth, user attribtue extensions, user-to-organization relationship and much more
      link: /docs/features/highly-customizable
      icon:
          type: svg
          value: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-settings-icon lucide-settings"><path d="M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915"/><circle cx="12" cy="12" r="3"/></svg>'
          collection: logos
          name: typescript-icon
    - title: Full Admin Site
      description: Admin site to manage chat apps, view insights, review chat sessions and much more
      link: /docs/features/admin-site
      icon:
          type: svg
