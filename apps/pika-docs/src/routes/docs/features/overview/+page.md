...
description: An overview of the platform's features
outline: [2, 3]
---

Pika helps teams ship capable, governed AI chat apps fast. Below is a quick tour of what you get out of the box.
...
- **Highly Customizable**: Auth, roles, entities, UI, tags, features, and overrides.
- **Admin Site**: Enable/disable apps, manage access, review sessions, and explore insights.
...
- <Link to="/docs/features/highly-customizable" label="Highly Customizable" />
- <Link to="/docs/features/admin-site" label="Admin Site" />

:::tip[Need implementation details?]
These pages describe what’s possible. When you’re ready to build, see the Developer Docs in the left nav for how-tos and APIs.
:::
