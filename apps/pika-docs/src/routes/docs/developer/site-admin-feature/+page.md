---
title: Site Admin Feature
description: Imported from docs/developer/site-admin-feature.md
outline: [2, 3]
---
...
**📖 Comprehensive Guide:** For complete details about how all access control rules work together, see the [Chat App Access Control Guide](/docs/developer/chat-app-access-control/).
...
- **[Entity Feature](/docs/developer/entity-feature/)**: Complete guide to the entity feature and its configuration
- **[Authentication Guide](/docs/developer/authentication/)**: How to implement entity-based access control in your auth provider
- **[User Data Override Feature](/docs/developer/overriding-user-data/)**: Allows users to override their own data for testing
- **[Content Admin Feature](/docs/developer/content-admin/)**: Allows admins to view other users' chat content
- **[Overriding Features Guide](/docs/developer/overriding-features/)**: How individual chat apps can override site-level features

---

**Need more help?** Check the [Troubleshooting Guide](/docs/developer/troubleshooting/) or review the [Customization Guide](/docs/developer/customization/) for advanced configuration options.
