...
description: Imported from docs/developer/stack-management.md
outline: [2, 3]
---
...
![Pika Framework Architecture](/assets/svgs/framework-architecture.drawio.svg)
...
- [Local Development](/docs/developer/local-development/) - Running Pika locally
- [Customization Guide](/docs/developer/customization/) - How to customize Pika
