---
title: Content Admin
description: Imported from docs/developer/content-admin.md
outline: [2, 3]
---
...
Configure your authentication provider to assign the role automatically. See [Authentication Guide](/docs/developer/authentication/) for details on implementing role assignment logic.
