...
1. **Customize your application** - Read the [Customization Guide](/docs/developer/customization/)
2. **Set up authentication** - Follow the [Authentication Setup](/docs/developer/authentication/)
...
**Ready to customize your application?** Check out the [Customization Guide](/docs/developer/customization/) to start building your own features!
