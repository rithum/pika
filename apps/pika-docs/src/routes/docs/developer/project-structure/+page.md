...
2. **Learn about customization** - Read the [Customization Guide](/docs/developer/customization/)
3. **Set up authentication** - Follow the [Authentication Setup](/docs/developer/authentication/)
4. **Deploy your services** - Check out [Local Development](/docs/developer/local-development/) or [AWS Deployment](/docs/developer/aws-deployment/)

---

**Ready to start customizing?** Check out the [Customization Guide](/docs/developer/customization/) to learn how to add your own features!
