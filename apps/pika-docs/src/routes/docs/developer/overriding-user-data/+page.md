---
title: Overriding User Data
description: Imported from docs/developer/overriding-user-data.md
outline: [2, 3]
---
...
- More site-level configuration details in the [Customization Guide](/docs/developer/customization/)
- Override precedence and best practices in [Overriding Features](/docs/developer/overriding-features/)
