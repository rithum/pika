---
title: Installation
description: Imported from docs/developer/installation.md
outline: [2, 3]
---
...
👉 **Learn more:** [Getting Started Security Guide](/docs/developer/getting-started/#critical-security-and-authentication)
