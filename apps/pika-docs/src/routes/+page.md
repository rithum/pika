---
title: Pika Platform
description: Create full-featured agent chat apps fast
tagline: An AWS framework for sparking agent innovation by supporting rapid iteration
actions:
    - label: Get Started
...
features:
    ...
    - title: Built on Amazon Web Services
      ...
      icon:
          ...
          collection: logos
          name: svelte-kit
      link: /docs/developer/project-structure/
    - title: LLM-baased Agents
      ...
      link: /docs/developer/customization/
