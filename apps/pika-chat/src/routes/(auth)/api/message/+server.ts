    ...
    try {
        ...
        try {
            ...
            if (authProvider.getCustomDataFieldPathToMatchUsersEntity) {
                getCustomDataFieldPathToMatchUsersEntity =
                    await authProvider.getCustomDataFieldPathToMatchUsersEntity();
            }
        ...
        const { chatDisclaimerNotice, traces, logout, ...featuresForConverse } = getOverridableFeatures(
            chatApp,
            locals.user
        );
