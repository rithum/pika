...
// export function createDefaultSimpleSearch(): SimpleSearchState {
...
//         insightsStatus: 'all',
//         feedbackStatus: 'all',
//         showMyFeedbackOnly: false,
//         showHighCostOnly: false
//     };
// }

// export function createDefaultAdvancedSearch(): AdvancedSearchState {
//     return {
//         ...createDefaultSimpleSearch(),
//         specificUsers: [],
//         specificChatApps: [],
//         sessionIdPattern: '',
//         insightsFilters: {
//             goalScoreRange: [0, 10],
//             satisfactionScoreRange: [0, 10],
//             aiPerformanceScoreRange: [0, 10],
//             userSentiment: [],
...
// function mapFeedbackStatusToSeverity(status: SimpleSearchState['feedbackStatus']): string[] | undefined {
//     switch (status) {
//         case 'positive':
//             return ['low'];
//         case 'negative':
