...
{#snippet beneathToolbarContent()}
    ...
    <div class="border-t border-b bg-gradient-to-r from-info-bg to-muted/30 px-4 py-2.5 flex items-center gap-3">
        <div class="flex items-center gap-2">
            <div class="p-1.5 bg-info/10 rounded-md">
                <Filter class="w-3.5 h-3.5 text-info" />
            </div>
            <div class="flex flex-col">
                <span class="text-xs font-semibold text-foreground leading-none">Quick Filter</span>
        ...
        <div class="flex items-center gap-2">
            <Input
                ...
                class="h-8 w-[280px] text-sm border-border focus-visible:ring-ring"
            />
            {#if globalFilterProps.globalFilterValue}
                <Button
                    variant="ghost"
                    size="sm"
                    class="h-8 text-xs px-2 hover:bg-accent"
