import { L as block, M as EFFECT_TRANSPARENT, N as branch, O as noop, P as destroy_effect, D as hydrating, Q as hydrate_node, R as effect, E as render_effect, H as untrack, S as queue_micro_task, T as STATE_SYMBOL, U as clsx, c as create_custom_element, p as push, J as prop, x as comment, o as first_child, i as if_block, b as append, j as pop, K as flushSync, g as from_html, a as attribute_effect, r as rest_props, n as child, w as reset } from "./wc-utils-za2Oi3n3.js";
  ...
  let w = (u$1, $) => {
    ...
    let N = x(c$1?.slots), O = x(M) ? {} : { base: u(u$1?.base, N && c$1?.base), ...M }, j$1 = N ? O : d({ ...c$1?.slots }, x(O) ? { base: u$1?.base } : O), T2 = x(c$1?.compoundVariants) ? L : g(c$1?.compoundVariants, L), y2 = (h$1) => {
      ...
      let Y = (t, e, n = [], a$1) => {
        ...
        if (typeof i2 == "object" && l) for (let [C, H] of Object.entries(i2)) {
          let te = r[H];
          if (C === "initial") {
            f2 = H;
            continue;
...
const buttonVariants = T({
  ...
  variants: {
    variant: {
      ...
      destructive: "bg-destructive shadow-xs hover:bg-destructive/90 active:bg-destructive/70 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 text-white",
      outline: "bg-background shadow-xs hover:bg-accent hover:text-accent-foreground active:brightness-90 active:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 border",
      secondary: "bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80 active:brightness-90",
...
function Button($$anchor, $$props) {
  push($$props, true);
  let className = prop($$props, "class", 7), variant = prop($$props, "variant", 7, "default"), size = prop($$props, "size", 7, "default"), ref = prop($$props, "ref", 15, null), href = prop($$props, "href", 7, void 0), type = prop($$props, "type", 7, "button"), disabled = prop($$props, "disabled", 7), children = prop($$props, "children", 7), restProps = rest_props($$props, [
    "$$slots",
    "$$events",
    "$$legacy",
    "$$host",
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      attribute_effect(
        ...
        [
          () => cn(buttonVariants({ variant: variant(), size: size() }), className())
        ]
      );
      var node_1 = child(a2);
